...
4. Write the commit message in this format:
   ...
   ```
   <type>(<scope>): Claude-Workshop <summary in imperative mood, ≤72 chars>
...
- Body: always include both What and Why sections and branch id, optional for chore and style commits
- Keep the summary under 72 characters
- If changes don't fit a single type, split into multiple commits
- Add  co-author trailers at end of commit message after branch-id
